...
type ColumnDef struct {
  ...
  Type PropertyType `thrift:"type,2,required" db:"type" json:"type"`
  DefaultValue *nebula0.Value `thrift:"default_value,3" db:"default_value" json:"default_value,omitempty"`
  TypeLength int16 `thrift:"type_length,4" db:"type_length" json:"type_length,omitempty"`
  Nullable bool `thrift:"nullable,5" db:"nullable" json:"nullable,omitempty"`
}
...
func (p *ColumnDef) GetType() PropertyType {
  return p.Type
}
var ColumnDef_DefaultValue_DEFAULT *nebula0.Value
func (p *ColumnDef) GetDefaultValue() *nebula0.Value {
  if !p.IsSetDefaultValue() {
    return ColumnDef_DefaultValue_DEFAULT
  }
return p.DefaultValue
}
var ColumnDef_TypeLength_DEFAULT int16 = 0

func (p *ColumnDef) GetTypeLength() int16 {
  return p.TypeLength
}
...
func (p *ColumnDef) IsSetTypeLength() bool {
  return p.TypeLength != ColumnDef_TypeLength_DEFAULT
}
...
func (p *ColumnDef)  ReadField3(iprot thrift.Protocol) error {
  p.DefaultValue = nebula0.NewValue()
...
func (p *ColumnDef) writeField4(oprot thrift.Protocol) (err error) {
  if p.IsSetTypeLength() {
    if err := oprot.WriteFieldBegin("type_length", thrift.I16, 4); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 4:type_length: ", p), err) }
    if err := oprot.WriteI16(int16(p.TypeLength)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.type_length (4) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 4:type_length: ", p), err) }
  }
  return err
}
...
func (p *ColumnDef) writeField5(oprot thrift.Protocol) (err error) {
  if p.IsSetNullable() {
    if err := oprot.WriteFieldBegin("nullable", thrift.BOOL, 5); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:nullable: ", p), err) }
    if err := oprot.WriteBool(bool(p.Nullable)); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T.nullable (5) field write error: ", p), err) }
    if err := oprot.WriteFieldEnd(); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field end error 5:nullable: ", p), err) }
  }
  return err
}
...
func (p *ListSpacesResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Spaces = append(p.Spaces, _elem13)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *AlterTagReq)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.TagItems = append(p.TagItems, _elem14)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *AlterEdgeReq)  ReadField3(iprot thrift.Protocol) error {
  ...
  p.EdgeItems =  tSlice
  for i := 0; i < size; i ++ {
    _elem16 := NewAlterSchemaItem()
    if err := _elem16.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem16), err)
    }
    p.EdgeItems = append(p.EdgeItems, _elem16)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ListEdgesResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Edges = append(p.Edges, _elem17)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ListHostsResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Hosts = append(p.Hosts, _elem18)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ListPartsReq)  ReadField2(iprot thrift.Protocol) error {
  ...
  p.PartIds =  tSlice
  for i := 0; i < size; i ++ {
var _elem21 nebula0.PartitionID
    if v, err := iprot.ReadI32(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
} else {
    temp := nebula0.PartitionID(v)
    ...
    p.PartIds = append(p.PartIds, _elem21)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ListPartsResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Parts = append(p.Parts, _elem22)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *GetPartsAllocResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  p.Parts =  tMap
  for i := 0; i < size; i ++ {
var _key23 nebula0.PartitionID
    if v, err := iprot.ReadI32(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
} else {
    temp := nebula0.PartitionID(v)
...
func (p *HBReq)  ReadField4(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
var _key30 nebula0.GraphSpaceID
    if v, err := iprot.ReadI32(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
} else {
    temp := nebula0.GraphSpaceID(v)
    ...
    _val31 :=  tSlice
    for i := 0; i < size; i ++ {
var _elem32 nebula0.PartitionID
      if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
} else {
      temp := nebula0.PartitionID(v)
...
type CreateTagIndexReq struct {
  ...
  Fields [][]byte `thrift:"fields,4" db:"fields" json:"fields"`
...
func (p *CreateTagIndexReq) GetFields() [][]byte {
  return p.Fields
}
...
func (p *CreateEdgeIndexReq) GetFields() [][]byte {
  return p.Fields
}
...
var _elem35 []byte
    ...
    p.Fields = append(p.Fields, _elem35)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ListRolesResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Roles = append(p.Roles, _elem39)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ListSnapshotsResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Snapshots = append(p.Snapshots, _elem45)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
