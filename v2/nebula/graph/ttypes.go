...
func (p *PlanNodeDescription)  ReadField5(iprot thrift.Protocol) error {
  ...
  p.Profiles =  tSlice
  for i := 0; i < size; i ++ {
    _elem5 := NewProfilingStats()
    if err := _elem5.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem5), err)
    }
    p.Profiles = append(p.Profiles, _elem5)
  }
...
var _elem6 int64
    ...
    p.Dependencies = append(p.Dependencies, _elem6)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *PlanDescription)  ReadField1(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    _elem7 := NewPlanNodeDescription()
    if err := _elem7.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem7), err)
    }
    p.PlanNodeDescs = append(p.PlanNodeDescs, _elem7)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
