...
func (p *LookupIndexRequest)  ReadField7(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.OrderBy = append(p.OrderBy, _elem55)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *LookupIndexRequest)  ReadField8(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.StatColumns = append(p.StatColumns, _elem56)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ScanVertexRequest)  ReadField2(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    _val59 := NewScanCursor()
    if err := _val59.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _val59), err)
    }
...
func (p *ScanEdgeRequest)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.ReturnColumns = append(p.ReturnColumns, _elem63)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *TaskPara)  ReadField2(iprot thrift.Protocol) error {
  ...
  p.Parts =  tSlice
  for i := 0; i < size; i ++ {
    var _elem66 nebula0.PartitionID
    if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
    } else {
      temp := nebula0.PartitionID(v)
...
func (p *TaskPara)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.TaskSpecificParas = append(p.TaskSpecificParas, _elem67)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *AddPartReq)  ReadField4(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Peers = append(p.Peers, _elem79)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *DropCPRequest)  ReadField1(iprot thrift.Protocol) error {
  ...
  p.SpaceIds =  tSlice
  for i := 0; i < size; i ++ {
    var _elem81 nebula0.GraphSpaceID
    if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
    } else {
      temp := nebula0.GraphSpaceID(v)
    ...
    p.SpaceIds = append(p.SpaceIds, _elem81)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *BlockingSignRequest)  ReadField1(iprot thrift.Protocol) error {
  ...
  p.SpaceIds =  tSlice
  for i := 0; i < size; i ++ {
    var _elem82 nebula0.GraphSpaceID
    if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
    } else {
      temp := nebula0.GraphSpaceID(v)
    ...
    p.SpaceIds = append(p.SpaceIds, _elem82)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *GetLeaderPartsResp)  ReadField2(iprot thrift.Protocol) error {
  ...
  p.LeaderParts =  tMap
  for i := 0; i < size; i ++ {
    var _key83 nebula0.GraphSpaceID
    if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
    } else {
      temp := nebula0.GraphSpaceID(v)
...
func (p *RebuildIndexRequest)  ReadField2(iprot thrift.Protocol) error {
  ...
  p.Parts =  tSlice
  for i := 0; i < size; i ++ {
    var _elem87 nebula0.PartitionID
    if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
    } else {
      temp := nebula0.PartitionID(v)
    ...
    p.Parts = append(p.Parts, _elem87)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ChainAddEdgesRequest)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.PropNames = append(p.PropNames, _elem92)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ChainUpdateEdgeRequest)  ReadField5(iprot thrift.Protocol) error {
  ...
  p.Parts =  tSlice
  for i := 0; i < size; i ++ {
    var _elem93 nebula0.PartitionID
    if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
    } else {
      temp := nebula0.PartitionID(v)
    ...
    p.Parts = append(p.Parts, _elem93)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ChainDeleteEdgesRequest)  ReadField2(iprot thrift.Protocol) error {
  ...
  p.Parts =  tMap
  for i := 0; i < size; i ++ {
    var _key94 nebula0.PartitionID
    if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
    } else {
      temp := nebula0.PartitionID(v)
    ...
    for i := 0; i < size; i ++ {
      ...
      _val95 = append(_val95, _elem96)
    }
    if err := iprot.ReadListEnd(); err != nil {
      return thrift.PrependError("error reading list end: ", err)
    }
    p.Parts[_key94] = _val95
  }
  if err := iprot.ReadMapEnd(); err != nil {
    return thrift.PrependError("error reading map end: ", err)
  }
