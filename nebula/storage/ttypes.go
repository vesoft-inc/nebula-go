...
func (p *BlockingSignRequest)  ReadField1(iprot thrift.Protocol) error {
  ...
  p.SpaceIds =  tSlice
  for i := 0; i < size; i ++ {
    var _elem83 nebula0.GraphSpaceID
    if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
    } else {
      temp := nebula0.GraphSpaceID(v)
    ...
    p.SpaceIds = append(p.SpaceIds, _elem83)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *GetLeaderPartsResp)  ReadField2(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    _val85 :=  tSlice
    for i := 0; i < size; i ++ {
      var _elem86 nebula0.PartitionID
      if v, err := iprot.ReadI32(); err != nil {
        return thrift.PrependError("error reading field 0: ", err)
      } else {
        temp := nebula0.PartitionID(v)
...
func (p *RebuildIndexRequest)  ReadField2(iprot thrift.Protocol) error {
  ...
  p.Parts =  tSlice
  for i := 0; i < size; i ++ {
    var _elem88 nebula0.PartitionID
    if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
    } else {
      temp := nebula0.PartitionID(v)
    ...
    p.Parts = append(p.Parts, _elem88)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
