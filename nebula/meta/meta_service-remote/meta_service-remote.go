...
func main() {
  ...
  case "createSpace":
    ...
    arg84 := flag.Arg(1)
    mbTrans85 := thrift.NewMemoryBufferLen(len(arg84))
    ...
    factory87 := thrift.NewSimpleJSONProtocolFactory()
  ...
  case "dropSpace":
    ...
    arg90 := flag.Arg(1)
    mbTrans91 := thrift.NewMemoryBufferLen(len(arg90))
    ...
    factory93 := thrift.NewSimpleJSONProtocolFactory()
