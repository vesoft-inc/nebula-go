...
func NewMetaServiceProcessor(handler MetaService) *MetaServiceProcessor {
  self265 := &MetaServiceProcessor{handler:handler, processorMap:make(map[string]thrift.ProcessorFunction)}
  self265.processorMap["createSpace"] = &metaServiceProcessorCreateSpace{handler:handler}
  self265.processorMap["dropSpace"] = &metaServiceProcessorDropSpace{handler:handler}
  self265.processorMap["getSpace"] = &metaServiceProcessorGetSpace{handler:handler}
  self265.processorMap["listSpaces"] = &metaServiceProcessorListSpaces{handler:handler}
  self265.processorMap["createTag"] = &metaServiceProcessorCreateTag{handler:handler}
  self265.processorMap["alterTag"] = &metaServiceProcessorAlterTag{handler:handler}
  self265.processorMap["dropTag"] = &metaServiceProcessorDropTag{handler:handler}
  self265.processorMap["getTag"] = &metaServiceProcessorGetTag{handler:handler}
  self265.processorMap["listTags"] = &metaServiceProcessorListTags{handler:handler}
  self265.processorMap["createEdge"] = &metaServiceProcessorCreateEdge{handler:handler}
  self265.processorMap["alterEdge"] = &metaServiceProcessorAlterEdge{handler:handler}
  self265.processorMap["dropEdge"] = &metaServiceProcessorDropEdge{handler:handler}
  self265.processorMap["getEdge"] = &metaServiceProcessorGetEdge{handler:handler}
  self265.processorMap["listEdges"] = &metaServiceProcessorListEdges{handler:handler}
  self265.processorMap["listHosts"] = &metaServiceProcessorListHosts{handler:handler}
  self265.processorMap["getPartsAlloc"] = &metaServiceProcessorGetPartsAlloc{handler:handler}
  self265.processorMap["listParts"] = &metaServiceProcessorListParts{handler:handler}
  self265.processorMap["multiPut"] = &metaServiceProcessorMultiPut{handler:handler}
  self265.processorMap["get"] = &metaServiceProcessorGet{handler:handler}
  self265.processorMap["multiGet"] = &metaServiceProcessorMultiGet{handler:handler}
  self265.processorMap["remove"] = &metaServiceProcessorRemove{handler:handler}
  self265.processorMap["removeRange"] = &metaServiceProcessorRemoveRange{handler:handler}
  self265.processorMap["scan"] = &metaServiceProcessorScan{handler:handler}
  self265.processorMap["createTagIndex"] = &metaServiceProcessorCreateTagIndex{handler:handler}
  self265.processorMap["dropTagIndex"] = &metaServiceProcessorDropTagIndex{handler:handler}
  self265.processorMap["getTagIndex"] = &metaServiceProcessorGetTagIndex{handler:handler}
  self265.processorMap["listTagIndexes"] = &metaServiceProcessorListTagIndexes{handler:handler}
  self265.processorMap["rebuildTagIndex"] = &metaServiceProcessorRebuildTagIndex{handler:handler}
  self265.processorMap["listTagIndexStatus"] = &metaServiceProcessorListTagIndexStatus{handler:handler}
  self265.processorMap["createEdgeIndex"] = &metaServiceProcessorCreateEdgeIndex{handler:handler}
  self265.processorMap["dropEdgeIndex"] = &metaServiceProcessorDropEdgeIndex{handler:handler}
  self265.processorMap["getEdgeIndex"] = &metaServiceProcessorGetEdgeIndex{handler:handler}
  self265.processorMap["listEdgeIndexes"] = &metaServiceProcessorListEdgeIndexes{handler:handler}
  self265.processorMap["rebuildEdgeIndex"] = &metaServiceProcessorRebuildEdgeIndex{handler:handler}
  self265.processorMap["listEdgeIndexStatus"] = &metaServiceProcessorListEdgeIndexStatus{handler:handler}
  self265.processorMap["createUser"] = &metaServiceProcessorCreateUser{handler:handler}
  self265.processorMap["dropUser"] = &metaServiceProcessorDropUser{handler:handler}
  self265.processorMap["alterUser"] = &metaServiceProcessorAlterUser{handler:handler}
  self265.processorMap["grantRole"] = &metaServiceProcessorGrantRole{handler:handler}
  self265.processorMap["revokeRole"] = &metaServiceProcessorRevokeRole{handler:handler}
  self265.processorMap["listUsers"] = &metaServiceProcessorListUsers{handler:handler}
  self265.processorMap["listRoles"] = &metaServiceProcessorListRoles{handler:handler}
  self265.processorMap["getUserRoles"] = &metaServiceProcessorGetUserRoles{handler:handler}
  self265.processorMap["changePassword"] = &metaServiceProcessorChangePassword{handler:handler}
  self265.processorMap["heartBeat"] = &metaServiceProcessorHeartBeat{handler:handler}
  self265.processorMap["balance"] = &metaServiceProcessorBalance{handler:handler}
  self265.processorMap["leaderBalance"] = &metaServiceProcessorLeaderBalance{handler:handler}
  self265.processorMap["regConfig"] = &metaServiceProcessorRegConfig{handler:handler}
  self265.processorMap["getConfig"] = &metaServiceProcessorGetConfig{handler:handler}
  self265.processorMap["setConfig"] = &metaServiceProcessorSetConfig{handler:handler}
  self265.processorMap["listConfigs"] = &metaServiceProcessorListConfigs{handler:handler}
  self265.processorMap["createSnapshot"] = &metaServiceProcessorCreateSnapshot{handler:handler}
  self265.processorMap["dropSnapshot"] = &metaServiceProcessorDropSnapshot{handler:handler}
  self265.processorMap["listSnapshots"] = &metaServiceProcessorListSnapshots{handler:handler}
  self265.processorMap["runAdminJob"] = &metaServiceProcessorRunAdminJob{handler:handler}
  return self265
}
