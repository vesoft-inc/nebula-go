...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  ExecResponse chainDeleteEdges(ChainDeleteEdgesRequest req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := storage.NewInternalStorageServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "chainDeleteEdges":
    ...
    argvalue0 := storage.NewChainDeleteEdgesRequest()
