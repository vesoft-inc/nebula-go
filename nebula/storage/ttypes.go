...
func (p *GetLeaderPartsResp)  ReadField2(iprot thrift.Protocol) error {
  ...
  p.LeaderParts =  tMap
  for i := 0; i < size; i ++ {
var _key78 nebula0.GraphSpaceID
    if v, err := iprot.ReadI32(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
} else {
    temp := nebula0.GraphSpaceID(v)
    ...
    _val79 :=  tSlice
    for i := 0; i < size; i ++ {
var _elem80 nebula0.PartitionID
      if v, err := iprot.ReadI32(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
} else {
      temp := nebula0.PartitionID(v)
...
func (p *CheckPeersReq)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Peers = append(p.Peers, _elem81)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *RebuildIndexRequest)  ReadField2(iprot thrift.Protocol) error {
  ...
  p.Parts =  tSlice
  for i := 0; i < size; i ++ {
var _elem82 nebula0.PartitionID
    if v, err := iprot.ReadI32(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
} else {
    temp := nebula0.PartitionID(v)
    ...
    p.Parts = append(p.Parts, _elem82)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *InternalTxnRequest)  ReadField2(iprot thrift.Protocol) error {
  ...
  p.TermOfParts =  tMap
  for i := 0; i < size; i ++ {
var _key84 nebula0.PartitionID
    if v, err := iprot.ReadI32(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
} else {
    temp := nebula0.PartitionID(v)
...
func (p *InternalTxnRequest)  ReadField5(iprot thrift.Protocol) error {
  ...
  p.EdgeVer =  tMap
  for i := 0; i < size; i ++ {
var _key86 nebula0.PartitionID
    if v, err := iprot.ReadI32(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
} else {
    temp := nebula0.PartitionID(v)
...
var _elem88 int64
      ...
      _val87 = append(_val87, _elem88)
    }
    if err := iprot.ReadListEnd(); err != nil {
      return thrift.PrependError("error reading list end: ", err)
    }
    p.EdgeVer[_key86] = _val87
  }
  if err := iprot.ReadMapEnd(); err != nil {
    return thrift.PrependError("error reading map end: ", err)
  }
