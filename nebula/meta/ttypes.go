...
type HBReq struct {
  ...
  Version []byte `thrift:"version,6" db:"version" json:"version,omitempty"`
}
...
func (p *HBReq)  ReadField4(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
var _key42 nebula0.GraphSpaceID
    if v, err := iprot.ReadI32(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
} else {
    temp := nebula0.GraphSpaceID(v)
...
func (p *HBReq) String() string {
  ...
  gitInfoShaVal := fmt.Sprintf("%v", p.GitInfoSha)
  versionVal := fmt.Sprintf("%v", p.Version)
  return fmt.Sprintf("HBReq({Role:%s Host:%s ClusterID:%s LeaderPartIds:%s GitInfoSha:%s Version:%s})", roleVal, hostVal, clusterIDVal, leaderPartIdsVal, gitInfoShaVal, versionVal)
}
...
func (p *ListRolesResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Roles = append(p.Roles, _elem51)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *BalanceReq)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.HostDel = append(p.HostDel, _elem52)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ListSnapshotsResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Snapshots = append(p.Snapshots, _elem57)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ListZonesResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Zones = append(p.Zones, _elem62)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
var _elem64 []byte
    ...
    p.ZoneNames = append(p.ZoneNames, _elem64)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
var _elem65 []byte
    ...
    p.ZoneNames = append(p.ZoneNames, _elem65)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ListGroupsResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Groups = append(p.Groups, _elem66)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *BackupMeta)  ReadField1(iprot thrift.Protocol) error {
  ...
  p.BackupInfo =  tMap
  for i := 0; i < size; i ++ {
var _key71 nebula0.GraphSpaceID
    if v, err := iprot.ReadI32(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
} else {
    temp := nebula0.GraphSpaceID(v)
...
var _elem73 []byte
    ...
    p.MetaFiles = append(p.MetaFiles, _elem73)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
var _elem74 []byte
    ...
    p.Spaces = append(p.Spaces, _elem74)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
var _elem75 []byte
    ...
    p.Files = append(p.Files, _elem75)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *RestoreMetaReq)  ReadField2(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Hosts = append(p.Hosts, _elem76)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *SignInFTServiceReq)  ReadField2(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Clients = append(p.Clients, _elem77)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *ListFTClientsResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Clients = append(p.Clients, _elem78)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
type FTIndex struct {
  SpaceID nebula0.GraphSpaceID `thrift:"space_id,1" db:"space_id" json:"space_id"`
  DependSchema *SchemaID `thrift:"depend_schema,2" db:"depend_schema" json:"depend_schema"`
...
var FTIndex_DependSchema_DEFAULT *SchemaID
func (p *FTIndex) GetDependSchema() *SchemaID {
...
var _elem79 []byte
    ...
    p.Fields = append(p.Fields, _elem79)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *Session)  ReadField10(iprot thrift.Protocol) error {
  ...
  p.Queries =  tMap
  for i := 0; i < size; i ++ {
var _key84 nebula0.ExecutionPlanID
    if v, err := iprot.ReadI64(); err != nil {
    return thrift.PrependError("error reading field 0: ", err)
} else {
...
func (p *UpdateSessionsReq)  ReadField1(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Sessions = append(p.Sessions, _elem86)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
var _key87 nebula0.SessionID
    ...
    _val88 :=  tMap
    for i := 0; i < size; i ++ {
var _key89 nebula0.ExecutionPlanID
      if v, err := iprot.ReadI64(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
} else {
      temp := nebula0.ExecutionPlanID(v)
      ...
      _val90 := NewQueryDesc()
      if err := _val90.Read(iprot); err != nil {
        return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _val90), err)
      }
...
func (p *ListSessionsResp)  ReadField3(iprot thrift.Protocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Sessions = append(p.Sessions, _elem91)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
var _key92 nebula0.SessionID
    ...
    _val93 :=  tSet
    for i := 0; i < size; i ++ {
var _elem94 nebula0.ExecutionPlanID
      if v, err := iprot.ReadI64(); err != nil {
      return thrift.PrependError("error reading field 0: ", err)
} else {
      temp := nebula0.ExecutionPlanID(v)
